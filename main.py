...
def main() -> None:
    print("VERSION: EMERGENCY_BYPASS_FORBIDDEN_MW + MBW_RSS_DIRECT_KEEP")
    args = parse_args()
    ...
    logging.info("MBW RSS entries kept: %s", counters["mbw_rss_kept"])
    ...
    logging.info("mbw_rss_kept=%s", counters["mbw_rss_kept"])
